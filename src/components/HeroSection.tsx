...
export default function HeroSection() {
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center px-6 pt-6 pb-12 md:pt-8 md:pb-16">
        {/* Logo */}
        <Image
        ...
        {/* Heading */}
        <h1
          className="font-heading text-[#111111] leading-[1.04] mt-5 max-w-sm mx-auto text-balance"
        ...
        <div className="relative mt-5" style={{ width: '260px', height: '300px' }}>
          <Stack
            cards={cards}
            autoplay
            autoplayDelay={2800}
          ...
          <div className="absolute bottom-4 left-0 right-0 flex justify-center z-20">
            <button
              className="bg-[#0D0D0D] text-white rounded-full px-8 py-3 text-[14px] font-medium transition-opacity hover:opacity-80 active:scale-[0.97] shadow-lg"
